...
Textures::Textures(){
    ...
    spaceWpn = LoadTexture("src/_resources/textures/spaceshot_icon.png");
    floor16 = LoadTexture("src/_resources/sprites/16x16_floor.png");
    grassyFloor = LoadTexture("src/_resources/sprites/16x16_grassy_floor.png");
    grassyWall = LoadTexture("src/_resources/sprites/16x32_grassy_wall.png");
    ...
    gameOver = LoadTexture("src/_resources/sprites/GAMEOVER1.png");
